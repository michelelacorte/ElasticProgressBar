...
public class ProgressDownloadView extends View {
    ...
    public ProgressDownloadView(Context context, AttributeSet attrs) {
        ...
        if(OptionView.isColorProgressBarSet) {
            mPaintBlack.setColor(getResources().getColor(OptionView.getColorProgressBar()));
        }else
        {
        ...
        if(OptionView.isColorProgressBarInProgressSet) {
            mPaintWhite.setColor(getResources().getColor(OptionView.getColorProgressBarInProgress()));
        }else
        {
        ...
        if(OptionView.isColorCloudSet) {
            mPaintBubble.setColor(getResources().getColor(OptionView.getColorCloud()));
        }else
        {
        ...
        if(OptionView.isColorProgressBarTextSet) {
            mPaintText.setColor(getResources().getColor(OptionView.getColorProgressBarText()));
        }else
        {
        ...
        if (mPathWhite != null && mPathBlack != null) {
            ...
            switch (mState) {
                ...
                case STATE_FAILED:
                    ...
                    mPaintText.setColor(getResources().getColor(mColorFail));
                ...
                case STATE_SUCCESS:
                    canvas.save();
                    mPaintText.setColor(getResources().getColor(mColorSuccess));
    ...
    public void setColorSuccess(int color)
    {
        mColorSuccess = color;
    }

    public void setColorFail(int color)
    {
        mColorFail = color;
    }
